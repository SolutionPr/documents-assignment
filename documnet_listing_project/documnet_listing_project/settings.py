"""
Django settings for documnet_listing_project project.
...
SECRET_KEY = 'django-insecure-)xqs405^u1-g57qa4ef1h1r11(9j@^p7authum^%p03$32rni('
...
WSGI_APPLICATION = 'documnet_listing_project.wsgi.application'
